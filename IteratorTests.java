...
public class IteratorTests {
    ...
    @Test
    public void testLegalIteratorCount() {

        Board b = new Board();
        Iterator<Move> iterator = b.legalMoves(Piece.WHITE);
        int count = 0;
    ...
    public void testLegalMoves() {
        Board b = new Board();
        buildBoard(b, reachableFromTestBoard); // FIXME
        int numMoves = 0;
...
//            assertTrue(false); // FIXME
        ...
        assertEquals(moves.size(), numMoves); // FIXME
